...
class PostType
{
    ...
    /**
     * Return a WordPress Loop which accepts a callback to run on each post
     *
     * @param array $args
     * @return void
     */
    ...
    private function loopThroughAll($callback, $args = [])
    {
    ...
    {
        return $this->loopThroughAll($callback, $args = []);
    }
}
